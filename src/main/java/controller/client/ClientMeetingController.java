...
public class ClientMeetingController {
    ...
    @FXML private Label pendingLabel, upcomingLabel, projectIDTextField, projectTitleTextField, noResultsLabel;
    ...
    public static void meetingSetUp(ComboBox<String> hourComboBox, ComboBox<String> minComboBox, ComboBox<String> whenComboBox, TextArea descripTextField, ComboBox<String> priorityComboBox, CheckBox virtualCheck, CheckBox officeCheck, CheckBox elsewhereCheck, TextField addressTextField) {
    ...
    public void addButtonClick(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/AddMeeting.fxml"));
    ...
    private void saveButtonClick() {
        try {
            ...
            if (title == null || title.trim().isEmpty() || agenda == null || agenda.trim().isEmpty() ||
            ...
            ((Client)currentUser).scheduleMeeting(projectId, title, agenda, date, time, location, address, priorityComboBox.getValue());
    ...
    private HBox createMeetingPanel(Meeting meeting) {
        ...
        meetingPanel.setOnMouseEntered(_ -> meetingPanel.setStyle("-fx-background-color: rgba(25, 13, 5, 0.7); -fx-background-radius: 10; -fx-text-fill: white;"));
        meetingPanel.setOnMouseExited(_ -> meetingPanel.setStyle("-fx-background-color: rgba(25, 13, 5, 0.5); -fx-background-radius: 10; -fx-text-fill: white;"));
        return meetingPanel;
    }
    ...
    private void rescheduleMeeting(Meeting meeting) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/EditMeeting.fxml"));
            Parent newFormRoot = loader.load();
    ...
    public static void meetingPanelSetUp(Project project, VBox projectPanel) {
    ...
    private void pendingMeetingPopupPanel(Meeting meeting, VBox overlayBox){
        ...
        if (meeting.getRecipientId() == currentUser.getUserId()) {
            ...
            Button rejectButton = createButton("Reject Meeting Request", "rgba(0,128,0,0.3)");

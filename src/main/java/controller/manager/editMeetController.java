...
public class editMeetController {
    User manager;
    Meeting meet;
    Project proj;
    ...
    @FXML private void saveButtonClick() {
        try {
            ...
            ((ProjectManager) manager).updateMeeting(meet);
    ...
    private void populateProjectPanel() {
        ...
        proj = Factory.getProjectServices().getProjectById(((ProjectManager)manager).getProjects(), meet.getProject_id());
